...
const Hero = () => {
  return (
    <section className="h-screen relative overflow-hidden mt-[-72px]">
      ...
      {/* Hero Content */}
      <div className="container relative z-[4] h-full flex items-center">
        <div className="max-w-[702px]">
          <h1 className="capitalize text-6xl leading-[80px] tracking-[5px] mb-16 text-white">
      ...
      {/* Hero Image */}
      <div className="absolute z-[3] bottom-[-10%] right-0 max-w-[720px] w-full">
        <Image
